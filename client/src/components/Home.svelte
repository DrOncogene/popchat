...
<section class="main-section flex items-center justify-center h-full w-full overflow-hidden">
  <div class="block md:grid md:grid-cols-home w-full md:max-w-[1040px] h-full md:h-[550px] md:m-auto bg-dark-pri shadow-xl shadow-black overflow-hidden">
    <aside class="left relative md:flex flex-col md:border-r md:border-r-gray-500 h-screen md:h-full w-full md:m-0 md:w-[350px] overflow-hidden transition-all duration-500">
      ...
      <button on:click={toggleRoomWidget} class="peer absolute right-4 bottom-4 w-12 h-12 rounded-full bg-pri-900 flex justify-center items-center shadow-lg shadow-black hover:shadow-none transition-shadow duration-300 z-50">
        <ChatPlus size="2em" />
      </button>
    </aside>
    <div class="right absolute top-0 left-0 md:block md:relative w-full h-full md:h-[550px] overflow-hidden translate-x-full md:translate-x-0 transition-all duration-500">
