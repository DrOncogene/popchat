...
from fastapi import APIRouter, Cookie, Form, Depends, Security
...
from app.schemas.models import UserLogin, UserRegister, ResponseModel
from app.settings import settings
from app.middlewares.auth import register_user, JWT, authenticate, login_user
